...
const RPC: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.CRO_TESTNET]: "https://evm-t3.cronos.org",
  [ChainId.LIBERTY_16]: "https://liberty10.shardeum.org",
  [ChainId.DAPPS_NETWORK]: "https://liberty20.shardeum.org",
  [ChainId.ZETA_ATHENS]: "https://api.athens2.zetachain.com/evm",
